...
| `multi_agent_evaluation` | `.cursor/skills/multi-agent-evaluation/SKILL.md`（A/B 並列分析 + C 独立裁定。要件・方針の多角評価）/ `references/analyst-brief.md` / `references/verification-flags.md` / `references/issue-card-format.md` / `references/decision-report.md` |
